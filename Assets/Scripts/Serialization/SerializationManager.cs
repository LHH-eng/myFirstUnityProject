...
/// <summary>
/// 직렬화(Object -> File)
/// 역직렬화(File -> Object)를 Unity의 JsonUtility클래스를 사용하여 테스트
/// </summary>
public class SerializationManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string newJson = JsonUtility.ToJson(person);
        ...
        // 역직렬화: JSON형식과 같은 필드명을 가진 클래스 필요
        Person person2 = JsonUtility.FromJson<Person>(readJson);
        print($"나는 제 2의 {person2.name}입니다.");
