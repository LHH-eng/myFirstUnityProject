...
/// <summary>
/// Navigation Agent가 특정 타켓을 따라가게 한다.
...
public class NavigationManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //if(agents != null || agents.Count > 0) // 방어코드(agents가 없을때 error를 막아줌)
        //{
        //    // Navigation Agent가 특정 타켓을 따라가게 한다.
        ...
        {
            Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition); // nearPlan의 위치 기준으로 방선을 발사
